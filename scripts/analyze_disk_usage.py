...
class DiskAnalyzer:
    ...
    def analyze_logs(self):
        ...
        if total_size > 1024 * 1024 * 1024:  # > 1GB
            ...
            print(f"  💡 Recommendation: Run cleanup_old_data.py")
    ...
    def analyze_database(self):
        ...
        if total_size > 500 * 1024 * 1024:  # > 500MB
            print(f"  💡 Recommendation: Run optimize_database.py")
    ...
    def analyze_ml_data(self):
        ...
        if total_size > 3 * 1024 * 1024 * 1024:  # > 3GB
            ...
            print(f"  💡 Recommendation: Clean old historical data")
    ...
    def analyze_backups(self):
        ...
        if size > 1024 * 1024 * 1024:  # > 1GB
            print(f"  💡 Recommendation: Remove old backups")
    ...
    def analyze_temp_files(self):
        ...
        if total_size > 100 * 1024 * 1024:  # > 100MB
            print(f"  💡 Recommendation: Clean temp files")
