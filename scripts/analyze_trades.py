...
def main():
    ...
    print(
        f"Profitable Trades: {
            overall['profitable_trades']} ({
            overall['win_rate']:.1f}% win rate)")
    ...
    print(
        f"Max Drawdown: {
            format_pnl(
                advanced['max_drawdown'])} ({
            advanced['max_drawdown_pct']:.1f}%)")
    ...
    if patterns:
        ...
        print(
            f"Long Trades: {
                patterns['long_trades']} (Avg: {
                format_pnl(
                    patterns['avg_profit_long'])})")
        print(
            f"Short Trades: {
                patterns['short_trades']} (Avg: {
                format_pnl(
                    patterns['avg_profit_short'])})")
    else:
