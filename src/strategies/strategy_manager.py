...
class StrategyManager:
    ...
    def __init__(self, config, client, database, risk_manager):
        ...
        if self.trade_with_trend_only:
            self.logger.info(f"Trading WITH TREND ONLY - minimum strength: {self.min_trend_strength}")
    ...
    def _execute_buy(self, signal: Dict, strategy: BaseStrategy):
        ...
        try:
            ...
            self.logger.info(f"Open positions count after creating position {position_id}: {open_positions_count}")
