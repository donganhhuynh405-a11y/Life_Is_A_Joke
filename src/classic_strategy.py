...
class ClassicTradingStrategy:
    ...
    def analyze_market(self, df: pd.DataFrame) -> Dict:
        ...
        price_position = (close.iloc[-1] - lower_bb.iloc[-1]) / \
            (upper_bb.iloc[-1] - lower_bb.iloc[-1])
        ...
        buy_conditions = {
            ...
            # Цена ниже средней линии Боллинджера
            'price_lower_band': close.iloc[-1] < middle_bb.iloc[-1]
        }
        ...
        sell_conditions = {
            ...
            'price_upper_band': close.iloc[-1] > middle_bb.iloc[-1]
        }
