...
class Reporter:
    ...
    def generate_daily_report(
        ...
        story.append(Paragraph(
            f'Ежедневный отчёт - {datetime.utcnow().strftime("%Y-%m-%d")}', styles['Title']))
    ...
    def generate_hourly_report(self, metrics: dict, trends: dict = None, filename=None):
        ...
        if trends:
            ...
            plan_text += "<br/><b>Управление рисками:</b> Адаптация размера позиций под силу тренда"
