...
class NewsStrategyIntegrator:
    ...
    def get_news_signal(self, sentiment_data: Dict, symbol: str = None) -> Dict[str, any]:
        ...
        return {
            ...
            'strength': strength,
            'reason': reason,
            'confidence': strength * (total / 10.0) if total > 0 else 0.0  # More news = higher confidence
        }
    ...
    def get_recommendation(self, sentiment_data: Dict, current_position: Optional[Dict] = None) -> str:
        """
